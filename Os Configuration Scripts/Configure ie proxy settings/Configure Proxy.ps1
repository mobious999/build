<#
.SYNOPSIS
  This script can be used to configure i.e. proxy settings
...
.INPUTS
  ...
  $proxyserver - the proxy server to point to (url)
  $proxyenable - enable / disable use proxy server
...
Try {
  Set-Location "HKCU:\Software\Microsoft\Windows\CurrentVersion\Internet Settings"
	Set-ItemProperty . -Name ProxyServer -Value $proxyserver
	Set-ItemProperty . -Name ProxyEnable -Value $proxyenable 
}
